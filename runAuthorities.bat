@echo off
start cmd /c "java -cp C:\Users\Marta\Documents\NetBeansProjects\FYP\target\FYP-1.0-SNAPSHOT-jar-with-dependencies fyp.UI.MainTest && pause"
...
timeout 5
start cmd /c "java -cp C:\Users\Marta\Documents\NetBeansProjects\FYP\target\FYP-1.0-SNAPSHOT-jar-with-dependencies fyp.UI.UserInput && pause"
